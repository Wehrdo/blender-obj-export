...
bl_info = {
    "name": "Wavefront OBJ format - all normals",
...
class ImportOBJ(bpy.types.Operator, ImportHelper, IOOBJOrientationHelper):
    ...
    bl_idname = "import_scene_all_normals.obj"
    bl_label = "Import OBJ"
...
class ExportOBJ(bpy.types.Operator, ExportHelper, IOOBJOrientationHelper):
    ...
    bl_idname = "export_scene_normals.obj"
    bl_label = 'Export OBJ'
    bl_options = {'PRESET'}
    ...
    all_normals = BoolProperty(
            name="Write All Normals",
            description="Write all normals, including duplicates",
            default=True,
            )
